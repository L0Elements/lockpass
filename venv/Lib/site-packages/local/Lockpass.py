...
class lockpass():
    ...
    def newbook(name, description, ):
    #it creates a new book, after checking it does not exist
        try:
        ...
        return 0
    def initialize(): #initialize the base directories
        try:
            os.mkdir("Data")
        except:
            pass
        try:
            ...
            pass
        return 0
    def booklist():	# it returns an array listing all the books
        try:
            ...
            return 1
        return list
    def rmbook(name): #it removes a book
        list = lockpass.booklist()
    ...
    def addpasswd(bookname, account_location, account_username, password , type): #it adds a new password to a book
        list = lockpass.booklist()
